...
nemo_toolbar_constructed (GObject *obj)
{
    ...
    /* Up */ 
    button = toolbar_create_toolbutton (self, FALSE, NEMO_ACTION_UP);
    gtk_container_add (GTK_CONTAINER (box), button);
    ...
    /* Refresh */
    box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
    button = toolbar_create_toolbutton (self, TRUE, NEMO_ACTION_RELOAD);
    gtk_container_add (GTK_CONTAINER (box), button);
    gtk_style_context_add_class (gtk_widget_get_style_context (box), GTK_STYLE_CLASS_RAISED);
    gtk_box_pack_start (GTK_BOX (button_box), box, FALSE, FALSE, 0);
    ...
    /* Home */
    button = toolbar_create_toolbutton (self, FALSE, NEMO_ACTION_HOME);
    gtk_container_add (GTK_CONTAINER (box), button);

    /* Computer */
    button = toolbar_create_toolbutton (self, FALSE, NEMO_ACTION_COMPUTER);
    gtk_container_add (GTK_CONTAINER (box), button);
    ...
    /* Search */
    box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
    button = toolbar_create_toolbutton (self, TRUE, NEMO_ACTION_SEARCH);
    gtk_container_add (GTK_CONTAINER (box), button);
    gtk_style_context_add_class (gtk_widget_get_style_context (box), GTK_STYLE_CLASS_RAISED);
    gtk_box_pack_end (GTK_BOX (button_box), box, FALSE, FALSE, 0);
    ...
    /* New Folder */
    box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
    button = toolbar_create_toolbutton (self, TRUE, NEMO_ACTION_NEW_FOLDER);
    gtk_container_add (GTK_CONTAINER (box), button);
    gtk_style_context_add_class (gtk_widget_get_style_context (box), GTK_STYLE_CLASS_RAISED);
    gtk_box_pack_end (GTK_BOX (button_box), box, FALSE, FALSE, 0);
    ...
    box = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
    button = toolbar_create_toolbutton (self, TRUE, NEMO_ACTION_TOGGLE_LOCATION);
    gtk_container_add (GTK_CONTAINER (box), button);
    gtk_style_context_add_class (gtk_widget_get_style_context (box), GTK_STYLE_CLASS_RAISED);
    gtk_box_pack_end (GTK_BOX (button_box), box, FALSE, FALSE, 0);
